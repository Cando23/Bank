...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'passport_number' => 'required|numeric:7'.Rule::unique('users')->ignore($this->id),
            'passport_id_number' => ['required','regex:/\d{7}[A-Z]\d{3}[A-Z]{2}\d/', Rule::unique('users')->ignore($this->id)],
            ...
            'email' =>'email:rfc,dns'.Rule::unique('users')->ignore($this->id),
