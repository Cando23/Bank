...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'passport_id_number' => ['required', Rule::unique('users')->ignore($this->route('user')), 'regex:/\d{7}[A-Z]\d{3}[A-Z]{2}\d{1}/'],
            ...
            'email' => ['email', 'nullable', Rule::unique('users')->ignore($this->route('user'))],
